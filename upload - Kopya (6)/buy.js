...
if (window.solflare) {
    ...
    connectWalletBtn.textContent = 'Install Solflare';
    connectWalletBtn.disabled = true;
    showToast('Please install Solflare wallet to continue', 'error');
}
        ...
        if (isMobile()) {
            if (isInSolflareBrowser()) {
                ...
                if (!wallet.isConnected) {
                    showToast('Network is connecting, please wait...', 'info');
                ...
                showToast('Please open this page in Solflare\'s dApp browser', 'info');
            }
        } else {
